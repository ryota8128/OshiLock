...
export const MOCK_CARDS: EventInfoWithUserContext[] = [
  {
    ...
    detail: '今夜25:00〜放送のオールナイトニッポンに生出演。リスナーからのメッセージ募集中。',
    category: 'MEDIA',
    ...
    commentCount: 15,
    savedCount: 78,
    sortDate: utc('2026-04-18T02:00:00Z'),
  ...
  },
  {
    ...
    detail: '明日12:00〜 幕張メッセにて握手会開催。第3部まであり。',
    category: 'EVENT',
    sourceReliability: 'OFFICIAL',
    ...
    commentCount: 32,
    savedCount: 210,
    sortDate: utc('2026-04-17T10:00:00Z'),
  ...
  },
  {
    ...
    detail: '7/20〜8/15の全国ツアーチケット先行受付開始。ファンクラブ会員は本日23:59まで。',
    category: 'EVENT',
    sourceReliability: 'OFFICIAL',
    ...
    commentCount: 24,
    savedCount: 156,
    sortDate: utc('2026-04-17T06:00:00Z'),
  ...
  },
  {
    ...
    detail: '7/5(金) 22:00〜放送のMステに生出演決定。新曲を初披露予定。',
    category: 'MEDIA',
    sourceReliability: 'OFFICIAL',
    ...
    commentCount: 18,
    savedCount: 89,
    sortDate: utc('2026-04-16T12:00:00Z'),
  ...
  },
  {
    ...
    detail: '7/12(土) 14:00〜 / 17:00〜 の2回公演。観覧無料、整理券配布あり。',
    category: 'EVENT',
    ...
    commentCount: 8,
    savedCount: 42,
    sortDate: utc('2026-04-15T08:00:00Z'),
  ...
  },
  {
    ...
    detail: 'メンバーのオフショット写真が公式インスタグラムに投稿されました。',
    category: 'SNS',
    sourceReliability: 'OFFICIAL',
    ...
    commentCount: 12,
    savedCount: 67,
    sortDate: utc('2026-04-18T03:00:00Z'),
  ...
  },
  {
    ...
    detail: 'non-no 8月号の表紙に決定。7/20発売。',
    category: 'MEDIA',
    sourceReliability: 'OFFICIAL',
    ...
    commentCount: 6,
    savedCount: 38,
    sortDate: utc('2026-04-14T10:00:00Z'),
  ...
  },
  {
    ...
    detail: '公式YouTubeチャンネルの登録者数が200万人を突破しました。',
    category: 'NEWS',
    sourceReliability: 'OFFICIAL',
    ...
    commentCount: 4,
    savedCount: 22,
    sortDate: utc('2026-04-13T14:00:00Z'),
